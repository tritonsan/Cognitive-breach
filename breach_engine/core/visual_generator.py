...
def should_trigger_fabrication(
    ...
    ULTRA-AGGRESSIVE: Visual counter-evidence is our core mechanic - ALWAYS generate when requested!
    ...
    # ULTRA-AGGRESSIVE: If tactic requires it, ALWAYS do it!
    # No stress restrictions - this is our flagship feature (Generative vs. Generative)
    # Unit 734 will fabricate evidence at ANY stress level to defend itself
    print(f"[FABRICATION CHECK] APPROVED: tactic requires it, load={cognitive_load:.1f}% (no minimum threshold)")
    return True
